...
<head>
    ...
    <style>
        ...
        .btn-style {
        background-color: #f90; /* Set default button background color to orange */
        color: #fff; /* Set default button text color to white */
        border: none; /* Remove default button border */
        border-radius: 5px; /* Add border radius for a rounded button */
        cursor: pointer; /* Change cursor to pointer on hover */
        transition: background-color 0.2s; /* Add a transition for the background color */
    }

    .btn-style:hover {
        background-color: #ff6f00; /* Change background color to a lighter orange on hover */
    }

    .btn-large {
        padding: 1rem 2rem; /* Adjust padding using rem units for responsiveness */
        font-size: 1rem;    /* Adjust font size using rem units for responsiveness */
            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="sub_categories.php?title=' . $row['title'] . '" class="text-decoration-none text-dark">';
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 d">
                            <div class="card border-0 rounded shadow">
                                ...
                                <div class="quantity">
                                    ...
                                    <input type="text" id="quantity_product<?php echo $show['id']; ?>"
                                        name="quantity_product<?php echo $show['id']; ?>" value="1">
                                ...
                                <div class="add-to-cart-btn">
                                    <form action="add_to_cart.php" method="post">
                                        ...
                                        <input type="hidden" name="product_name" value="<?php echo $show['ptitle']; ?>">
                                        <input type="hidden" name="quantity" value="1"
                                            id="quantity_hidden_product<?php echo $show['id']; ?>">
                                        <input type="hidden" name="price" value="<?php echo $show['price']; ?>">
                                        <button type="submit" class="btn-style btn-large" onclick="updateQuantity(<?php echo $show['id']; ?>)">Add to Cart</button>
