                    ...
                    while ($show = mysqli_fetch_array($data_show)) {
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 d">
                            <div class="card border-0 rounded shadow h-100">
                                ...
                                <div class="quantity">
                                    <button onclick="decrement('product<?php echo $show['id']; ?>')">-</button>
                                    <input type="text" id="quantity_product<?php echo $show['id']; ?>" value="1">
                                    <button onclick="increment('product<?php echo $show['id']; ?>')">+</button>
                                </div>
                                <div class="add-to-cart-btn">
                                    <button onclick="addToCart('product<?php echo $show['id']; ?>')" class="btn-style btn-large">Add
                                        to Cart</button>
                                </div>
                            </div>
                        </div>
...
if (isset($_POST['save'])) {
    ...
    $filename1 = $_FILES["thumb1"]["name"];
    $tempname1 = $_FILES["thumb1"]["tmp_name"];
